...
public class TestServer {
    ...
    private final Commissioner commissioner = new Commissioner("Виктор", "Хорошев","victor.net", "25345Qw&&", true);
    ...
    public void startStopServerTest() throws IOException, ClassNotFoundException {
        ...
        server.startServer(null);
        boolean isElectionStart = server.electionService.isElectionStart();
        ...
        assertAll(
                ...
                () -> assertEquals(isElectionStart, server.electionService.isElectionStart())
        );
    }
    ...
    public void registerTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        assertAll(
                () -> assertEquals(server.register(gson.toJson(request1)), gson.toJson(new RegisterDtoResponse(session.getSession(request1.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request2)), gson.toJson(new RegisterDtoResponse(session.getSession(request2.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request3)), gson.toJson(new RegisterDtoResponse(session.getSession(request3.newVoter()).getToken()))),
                () -> assertEquals(server.register( gson.toJson(request4)), gson.toJson(new ErrorDtoResponse(WRONG_FIRSTNAME))),
                () -> assertEquals(server.register(gson.toJson(request5)), gson.toJson(new ErrorDtoResponse(WRONG_FIRSTNAME))),
                () -> assertEquals(server.register(gson.toJson(request6)), gson.toJson(new ErrorDtoResponse(WRONG_FIRSTNAME))),
                () -> assertEquals(server.register(gson.toJson(request7)), gson.toJson(new ErrorDtoResponse(WRONG_FIRSTNAME))),
                () -> assertEquals(server.register(gson.toJson(request8)), gson.toJson(new RegisterDtoResponse(session.getSession(request8.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request9)), gson.toJson(new RegisterDtoResponse(session.getSession(request9.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request10)), gson.toJson(new RegisterDtoResponse(session.getSession(request10.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request11)), gson.toJson(new ErrorDtoResponse(WRONG_LASTNAME))),
                () -> assertEquals(server.register(gson.toJson(request12)), gson.toJson(new ErrorDtoResponse(WRONG_LASTNAME))),
                () -> assertEquals(server.register(gson.toJson(request13)), gson.toJson(new ErrorDtoResponse(WRONG_LASTNAME))),
                () -> assertEquals(server.register(gson.toJson(request14)), gson.toJson(new ErrorDtoResponse(WRONG_LASTNAME))),
                () -> assertEquals(server.register(gson.toJson(request15)), gson.toJson(new RegisterDtoResponse(session.getSession(request15.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request16)), gson.toJson(new RegisterDtoResponse(session.getSession(request16.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request17)), gson.toJson(new RegisterDtoResponse(session.getSession(request17.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request18)), gson.toJson(new ErrorDtoResponse(WRONG_PATRONYMIC))),
                () -> assertEquals(server.register(gson.toJson(request19)), gson.toJson(new ErrorDtoResponse(WRONG_PATRONYMIC))),
                () -> assertEquals(server.register(gson.toJson(request20)), gson.toJson(new ErrorDtoResponse(WRONG_PATRONYMIC))),
                () -> assertEquals(server.register(gson.toJson(request21)), gson.toJson(new ErrorDtoResponse(WRONG_PATRONYMIC))),
                () -> assertEquals(server.register(gson.toJson(request22)), gson.toJson(new RegisterDtoResponse(session.getSession(request22.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request23)), gson.toJson(new RegisterDtoResponse(session.getSession(request23.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request24)), gson.toJson(new RegisterDtoResponse(session.getSession(request24.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request25)), gson.toJson(new ErrorDtoResponse(WRONG_STREET))),
                () -> assertEquals(server.register(gson.toJson(request26)), gson.toJson(new ErrorDtoResponse(WRONG_STREET))),
                () -> assertEquals(server.register(gson.toJson(request27)), gson.toJson(new ErrorDtoResponse(WRONG_STREET))),
                () -> assertEquals(server.register(gson.toJson(request28)), gson.toJson(new ErrorDtoResponse(WRONG_STREET))),
                () -> assertEquals(server.register(gson.toJson(request29)), gson.toJson(new RegisterDtoResponse(session.getSession(request29.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request30)), gson.toJson(new ErrorDtoResponse(WRONG_HOUSE))),
                () -> assertEquals(server.register(gson.toJson(request31)), gson.toJson(new ErrorDtoResponse(WRONG_HOUSE))),
                () -> assertEquals(server.register(gson.toJson(request32)), gson.toJson(new RegisterDtoResponse(session.getSession(request32.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request33)), gson.toJson(new RegisterDtoResponse(session.getSession(request33.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request34)), gson.toJson(new ErrorDtoResponse(WRONG_APARTMENT))),
                () -> assertEquals(server.register(gson.toJson(request35)), gson.toJson(new ErrorDtoResponse(WRONG_LOGIN))),
                () -> assertEquals(server.register(gson.toJson(request36)), gson.toJson(new RegisterDtoResponse(session.getSession(request36.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request36)), gson.toJson(new ErrorDtoResponse("Вы уже зарегестрированны."))),
                () -> assertEquals(server.register(gson.toJson(request37)), gson.toJson(new RegisterDtoResponse(session.getSession(request37.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request38)), gson.toJson(new RegisterDtoResponse(session.getSession(request38.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request39)), gson.toJson(new RegisterDtoResponse(session.getSession(request39.newVoter()).getToken()))),
                () -> assertEquals(server.register(gson.toJson(request40)), gson.toJson(new ErrorDtoResponse(WRONG_PASSWORD))),
                () -> assertEquals(server.register(gson.toJson(request41)), gson.toJson(new ErrorDtoResponse(WRONG_PASSWORD))),
                () -> assertEquals(server.register(gson.toJson(request42)), gson.toJson(new ErrorDtoResponse(WRONG_PASSWORD))),
                () -> assertEquals(server.register(gson.toJson(request43)), gson.toJson(new ErrorDtoResponse(WRONG_PASSWORD))),
                () -> assertEquals(server.register(gson.toJson(request44)), gson.toJson(new ErrorDtoResponse(WRONG_PASSWORD))),
                () -> assertEquals(server.register(gson.toJson(request45)), gson.toJson(new ErrorDtoResponse(WRONG_PASSWORD))),
                () -> assertEquals(server.register(gson.toJson(request46)), gson.toJson(new ErrorDtoResponse(WRONG_PASSWORD))),
                () -> assertEquals(server.register(gson.toJson(request47)), gson.toJson(new ErrorDtoResponse(NULL_REGISTERVOTERDTOREQUEST))),
                () -> assertEquals(server.register(gson.toJson(request48)), gson.toJson(new ErrorDtoResponse(NULL_REGISTERVOTERDTOREQUEST))),
                () -> assertEquals(server.register(gson.toJson(request49)), gson.toJson(new ErrorDtoResponse(NULL_REGISTERVOTERDTOREQUEST))),
                () -> assertEquals(server.register(gson.toJson(request50)), gson.toJson(new ErrorDtoResponse(NULL_REGISTERVOTERDTOREQUEST))),
                () -> assertEquals(server.register(gson.toJson(request51)), gson.toJson(new ErrorDtoResponse(NULL_REGISTERVOTERDTOREQUEST))),
                () -> assertEquals(server.register(gson.toJson(request52)), gson.toJson(new ErrorDtoResponse(NULL_REGISTERVOTERDTOREQUEST))),
                () -> assertEquals(server.register(null), gson.toJson(new ErrorDtoResponse(NULL_REGISTERVOTERDTOREQUEST))),
                () -> assertEquals(server.register(gson.toJson(request53)), gson.toJson(new ErrorDtoResponse(WRONG_FIRSTNAME + WRONG_LASTNAME + WRONG_PATRONYMIC + WRONG_STREET + WRONG_HOUSE + WRONG_APARTMENT + WRONG_LOGIN + WRONG_PASSWORD)))
        );
        ...
        StartElectionDtoRequest startRequest = new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken());
        server.startElection(gson.toJson(startRequest));
        RegisterDtoRequest request54 = new RegisterDtoRequest(randomString(), randomString(), randomString(),randomString(),1, 1, "login111111", "1qQ&2$$$$$$$");
    ...
    public void loginTest() throws IOException, ClassNotFoundException {
        ...
        assertAll(
                ...
                () -> assertEquals(server.login(gson.toJson(loginDtoRequest4)), gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.WRONG_PASSWORD.getMessage()))),
                () -> assertEquals(server.login(gson.toJson(loginDtoRequest5)), gson.toJson(new ErrorDtoResponse(WRONG_PASSWORD))),
                () -> assertEquals(server.login(gson.toJson(loginDtoRequest6)), gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.NOT_FOUND.getMessage()))),
    ...
    public void getVoterListTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        assertAll(
                () -> assertEquals(server.getVoterList(gson.toJson(new GetVoterListDtoRequest(server.sessionService.getSession(server.voterService.get("loginNumber1")).getToken()))).length(), gson.toJson(new GetVotersListDtoResponse(voterSet)).length()),
    ...
    public void addCandidateTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        RegisterDtoRequest request2 = new RegisterDtoRequest(randomString(), randomString(), null, randomString(), 1, 1, "loginNumber2", "111^wW1234");
        RegisterDtoRequest request3 = new RegisterDtoRequest(randomString(), randomString(), null, randomString(), 1, 1, "loginNumber3", "111^wW1234");
        RegisterDtoRequest request4 = new RegisterDtoRequest(randomString(), randomString(), null, randomString(), 1, 1, "loginNumber4", "111^wW1234");
        server.register(gson.toJson(request1));
        server.register(gson.toJson(request2));
        server.register(gson.toJson(request3));
        ...
        StartElectionDtoRequest startRequest = new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken());
        server.startElection(gson.toJson(startRequest));
        assertEquals(gson.toJson(new ErrorDtoResponse(ELECTION_START)), server.addCandidate(gson.toJson(new AddCandidateDtoRequest(request4.newVoter().getLogin(), server.sessionService.getSession(request4.newVoter()).getToken()))));
        server.stopServer(null);
    }
    @Test
    public void confirmationCandidacyTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        text2.add("idea №3");
        assertAll(
                () -> assertEquals(EMPTY_JSON, server.confirmationCandidacy(gson.toJson(new ConfirmationCandidacyDtoRequest(server.sessionService.getSession(request1.newVoter()).getToken(), text1)))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(SESSION_NOT_FOUND)), server.confirmationCandidacy(gson.toJson(new ConfirmationCandidacyDtoRequest("1", text1)))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.confirmationCandidacy(null)),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.confirmationCandidacy(gson.toJson(new ConfirmationCandidacyDtoRequest(null, text1)))),
        ...
        StartElectionDtoRequest startRequest = new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken());
        server.startElection(gson.toJson(startRequest));
        assertEquals(gson.toJson(new ErrorDtoResponse(ELECTION_START)), server.confirmationCandidacy(gson.toJson(new ConfirmationCandidacyDtoRequest(server.sessionService.getSession(request2.newVoter()).getToken(), text2))));
        server.stopServer(null);
    }
    @Test
    public void withdrawCandidacyTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        text1.add("idea №1");
        text2.add("idea №1");
        server.confirmationCandidacy(gson.toJson(new ConfirmationCandidacyDtoRequest(server.sessionService.getSession(request1.newVoter()).getToken(), text1)));
        server.confirmationCandidacy(gson.toJson(new ConfirmationCandidacyDtoRequest(server.sessionService.getSession(request2.newVoter()).getToken(), text2)));
        assertAll(
        ...
        StartElectionDtoRequest startRequest = new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken());
        server.startElection(gson.toJson(startRequest));
        assertEquals(gson.toJson(new ErrorDtoResponse(ELECTION_START)), server.withdrawCandidacy(gson.toJson(new WithdrawCandidacyRequest(server.sessionService.getSession(request2.newVoter()).getToken()))));
        server.stopServer(null);
    }
    //TODO: МОККИТО
    @Test
    public void addIdeaTest() throws IOException, ServerException, ClassNotFoundException {
        ...
        StartElectionDtoRequest startRequest = new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken());
        server.startElection(gson.toJson(startRequest));
        assertEquals(gson.toJson(new ErrorDtoResponse(ELECTION_START)), server.addIdea(gson.toJson(new AddIdeaDtoRequest("idea №4", server.sessionService.getSession(request1.newVoter()).getToken()))));
        server.stopServer(null);
    }
    @Test
    public void estimateIdeaTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        StartElectionDtoRequest startRequest = new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken());
        server.startElection(gson.toJson(startRequest));
        assertEquals(gson.toJson(new ErrorDtoResponse(ELECTION_START)), server.estimateIdea(gson.toJson(new EstimateIdeaDtoRequest(server.voterService.get("loginNumber1").getLogin(), 1, server.sessionService.getSession(request3.newVoter()).getToken()))));
        server.stopServer(null);
    }
    @Test
    public void changeRatingTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        StartElectionDtoRequest startRequest = new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken());
        server.startElection(gson.toJson(startRequest));
        assertEquals(gson.toJson(new ErrorDtoResponse(ELECTION_START)), server.changeRating(gson.toJson(new ChangeRatingDtoRequest(token2, server.ideaService.getKey(server.sessionService.getVoter(token1), "idea №1"), 4))));
        server.stopServer(null);
    }
    @Test
    public void removeRatingTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        server.estimateIdea(gson.toJson(new EstimateIdeaDtoRequest(server.voterService.get("loginNumber1").getLogin(), 1, token2)));
        assertAll(
                () -> assertEquals(EMPTY_JSON, server.removeRating(gson.toJson(new RemoveRatingDtoRequest(token2, server.ideaService.getKey(server.sessionService.getVoter(token1), "idea №1"))))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(SESSION_NOT_FOUND)), server.removeRating(gson.toJson(new RemoveRatingDtoRequest("1", server.ideaService.getKey(server.sessionService.getVoter(token1), "idea №1"))))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.removeRating(gson.toJson(null))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.removeRating(gson.toJson(new RemoveRatingDtoRequest(null, server.ideaService.getKey(server.sessionService.getVoter(token1), "idea №1"))))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.removeRating(gson.toJson(new RemoveRatingDtoRequest(token2, null))))
        );
        LoginDtoRequest request = new LoginDtoRequest(commissioner.getLogin(), commissioner.getPassword());
        server.estimateIdea(gson.toJson(new EstimateIdeaDtoRequest(server.voterService.get("loginNumber1").getLogin(), 1, token2)));
        server.login(gson.toJson(request));
        StartElectionDtoRequest startRequest = new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken());
        server.startElection(gson.toJson(startRequest));
        assertEquals(gson.toJson(new ErrorDtoResponse(ELECTION_START)), server.removeRating(gson.toJson(new RemoveRatingDtoRequest(token2, server.ideaService.getKey(server.sessionService.getVoter(token1), "idea №1")))));
        server.stopServer(null);
    }
    @Test
    public void takeIdeaTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        assertAll(
                () -> assertEquals(EMPTY_JSON, server.takeIdea(gson.toJson(new TakeIdeaDtoRequest(token2, server.ideaService.getKey(server.sessionService.getVoter(token1), "idea №1"))))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.takeIdea(gson.toJson(null))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.takeIdea(gson.toJson(new TakeIdeaDtoRequest(null, server.ideaService.getKey(server.sessionService.getVoter(token1), "idea №1"))))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(SESSION_NOT_FOUND)), server.takeIdea(gson.toJson(new TakeIdeaDtoRequest("1", server.ideaService.getKey(server.sessionService.getVoter(token1), "idea №1"))))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.takeIdea(gson.toJson(new TakeIdeaDtoRequest(token2, null))))
        );
        LoginDtoRequest request = new LoginDtoRequest(commissioner.getLogin(), commissioner.getPassword());
        server.login(gson.toJson(request));
        StartElectionDtoRequest startRequest = new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken());
        server.startElection(gson.toJson(startRequest));
        assertEquals(gson.toJson(new ErrorDtoResponse(ELECTION_START)), server.takeIdea(gson.toJson(new TakeIdeaDtoRequest(token2, server.ideaService.getKey(server.sessionService.getVoter(token1), "idea №1")))));
        server.stopServer(null);
    }
    @Test
    public void removeIdeaTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        assertAll(
                () -> assertEquals(EMPTY_JSON , server.removeIdea(gson.toJson(new RemoveIdeaDtoRequest(token1, ideaKey)))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.removeIdea(gson.toJson(null))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.removeIdea(gson.toJson(new RemoveIdeaDtoRequest(null, ideaKey)))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(SESSION_NOT_FOUND)), server.removeIdea(gson.toJson(new RemoveIdeaDtoRequest("1", ideaKey)))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.removeIdea(gson.toJson(new RemoveIdeaDtoRequest(token1, null))))
        );
        ...
        StartElectionDtoRequest startRequest = new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken());
        server.startElection(gson.toJson(startRequest));
        assertEquals(gson.toJson(new ErrorDtoResponse(ELECTION_START)), server.removeIdea(gson.toJson(new RemoveIdeaDtoRequest(token1, ideaKey1))));
        server.stopServer(null);
    }
    @Test
    public void getCandidateMapTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        server.confirmationCandidacy(gson.toJson(new ConfirmationCandidacyDtoRequest(token2, new ArrayList<>())));
        assertAll(
                () -> assertEquals(gson.toJson(new GetCandidateMapDtoResponse(server.candidateService.getCandidateMap())), server.getCandidateMap(gson.toJson(new GetCandidateMapDtoRequest(token3)))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(SESSION_NOT_FOUND)), server.getCandidateMap(gson.toJson(new GetCandidateMapDtoRequest("1")))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.getCandidateMap(null)),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.getCandidateMap(gson.toJson(new GetCandidateMapDtoRequest(null))))
        );
        server.stopServer(null);
    }
    @Test
    public void getAllIdeasTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        assertAll(
                () -> assertEquals(gson.toJson(new GetAllIdeasDtoResponse(map)), server.getAllIdeas(gson.toJson(new GetAllIdeasDtoRequest(token2)))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(SESSION_NOT_FOUND)), server.getAllIdeas(gson.toJson(new GetAllIdeasDtoRequest("token2")))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.getAllIdeas(gson.toJson(null))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.getAllIdeas(gson.toJson(new GetAllIdeasDtoRequest(null))))
        );
        server.stopServer(null);
    }
    @Test
    public void getAllVotersIdeasTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        assertAll(
                () -> assertEquals(gson.toJson(new GetAllVotersIdeasDtoResponse(list)), server.getAllVotersIdeas(gson.toJson(new GetAllVotersIdeasDtoRequest(token1, strings)))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(SESSION_NOT_FOUND)), server.getAllVotersIdeas(gson.toJson(new GetAllVotersIdeasDtoRequest("token1", strings)))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.getAllVotersIdeas(gson.toJson(null))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.getAllVotersIdeas(gson.toJson(new GetAllVotersIdeasDtoRequest(null, strings)))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.getAllVotersIdeas(gson.toJson(new GetAllVotersIdeasDtoRequest("token1", null))))
        );
        server.stopServer(null);
    }
    @Test
    public void startElectionTest() throws IOException, ClassNotFoundException, ServerException {
        server.startServer(null);
        assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.startElection(gson.toJson(new StartElectionDtoRequest(null))));
        assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.startElection(gson.toJson(null)));
        assertEquals(gson.toJson(new ErrorDtoResponse("Вы не председатель коммиссии.")), server.startElection(gson.toJson(new StartElectionDtoRequest("1"))));
        server.stopServer(null);
    }
    @Test
    public void voteTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        server.confirmationCandidacy(gson.toJson(new ConfirmationCandidacyDtoRequest(server.sessionService.getSession(voter1.newVoter()).getToken(), new ArrayList<>())));
        server.confirmationCandidacy(gson.toJson(new ConfirmationCandidacyDtoRequest(server.sessionService.getSession(voter2.newVoter()).getToken(), new ArrayList<>())));
        assertEquals(gson.toJson(new ErrorDtoResponse("Голосование не началось.")), server.vote(gson.toJson(new VoteDtoRequest(server.sessionService.getSession(voter3.newVoter()).getToken(), "login1111111"))));
        server.login(gson.toJson(new LoginDtoRequest(commissioner.getLogin(), commissioner.getPassword())));
        server.startElection(gson.toJson(new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken())));
        assertAll(
                () -> assertEquals(EMPTY_JSON, server.vote(gson.toJson(new VoteDtoRequest(server.sessionService.getSession(voter3.newVoter()).getToken(), "login1111111")))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse("Кандидат не найден.")), server.vote(gson.toJson(new VoteDtoRequest(server.sessionService.getSession(voter3.newVoter()).getToken(), "login11112111")))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.vote(gson.toJson(new VoteDtoRequest(null , "login1111111")))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.vote(gson.toJson(null)))
        );
        server.electionService.setIsElectionStop(true);
        assertEquals(gson.toJson(new ErrorDtoResponse("Голосование закончилось.")), server.vote(gson.toJson(new VoteDtoRequest(server.sessionService.getSession(voter4.newVoter()).getToken(), "login1111111"))));
        server.stopServer(null);
    }
    @Test
    public void getElectionResultTest() throws IOException, ClassNotFoundException, ServerException {
        ...
        server.login(gson.toJson(new LoginDtoRequest(commissioner.getLogin(), commissioner.getPassword())));
        server.startElection(gson.toJson(new StartElectionDtoRequest(server.sessionService.getSession(commissioner).getToken())));
        server.vote(gson.toJson(new VoteDtoRequest(server.sessionService.getSession(voter3.newVoter()).getToken(), "login1111111")));
        Set<Candidate> candidateSet = new HashSet<>();
        candidateSet.add(new Candidate(voter1.newVoter()));
        assertAll(
                () -> assertEquals(gson.toJson(new GetElectionResultDtoResponse(candidateSet)), server.getElectionResult(gson.toJson(new GetElectionResultDtoRequest(server.sessionService.getSession(commissioner).getToken())))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse("Вы не председатель коммиссии.")), server.getElectionResult(gson.toJson(new GetElectionResultDtoRequest("1")))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.getElectionResult(gson.toJson(new GetElectionResultDtoRequest(null)))),
                () -> assertEquals(gson.toJson(new ErrorDtoResponse(NULL_VALUE)), server.getElectionResult(gson.toJson(null)))
        );
        server.stopServer(null);
    }
